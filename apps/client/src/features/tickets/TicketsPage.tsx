    ...
    <main className="app-page ticket-page">
      ...
      <section className="siq-card ticket-filters-card">
        ...
        {isOrganizationsError && (
          <div className="ticket-alert ticket-alert-error" style={{ marginTop: "1rem" }}>
      ...
      {!isLoadingOrganizations && organizations.length === 0 && (
        <section className="siq-card siq-card-padding ticket-empty-state">
          ...
          <p>Create an organization before managing tickets.</p>
      ...
      {selectedOrgId && (
        <section className="siq-card ticket-list-card">
          ...
          {isLoadingTickets && <div className="ticket-loading">Loading tickets...</div>}
              ...
              {tickets.map((ticket) => (
                ...
                >
                  ...
                  <span className="ticket-user-cell">
                    ...
                    <span>{ticket.assignee ? ticket.assignee.email : "Needs owner"}</span>
                  </span>
